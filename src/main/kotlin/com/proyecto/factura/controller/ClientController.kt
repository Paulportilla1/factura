...
class ClientController {
    ...
    @PostMapping
    fun save (@RequestBody client: Client): ResponseEntity<com.proyecto.factura.model.Client> {
        return ResponseEntity(clientService.save(client), HttpStatus.OK )
    }

    @PutMapping
    fun update (@RequestBody client: Client): ResponseEntity<com.proyecto.factura.model.Client> {
